...
#'@param num This parameter indicates if the result data.frame will contain the ranges as numbers (required for SSE analyses), Where state 0 is range AB (or widespread species living in both areas), state 1 is range B (or clusters-reg), and state 0 is A (or reg).
